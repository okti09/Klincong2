...
struct CameraContentView: View {
    ...
    //    var openingAnimationVM: PreparationTaskView = PreparationTaskView(fileName: "animate-processing-task")
    ...
    var body: some View {
        ZStack {
                    ...
                    ZStack {
                        ...
                        VStack {
                            ...
                            VStack(spacing: 24) {
                                ...
                                HStack(spacing: 28) {
                                    Image("icon-kitchen").resizable().frame(width: 40, height: 32).foregroundColor(.white)
                                    Image("icon-pillow").resizable().frame(width: 32, height: 32).foregroundColor(.white)
                                    Image("icon-table").resizable().frame(width: 40, height: 32).foregroundColor(.white)
                                    Image("icon-toilet").resizable().frame(width: 36, height: 32).foregroundColor(.white)
                                    Image("icon-wardrobe").resizable().frame(width: 36, height: 32).foregroundColor(.white)
                                }
                            }
                            Spacer()
            ...
            //
            //                    VStack(spacing: 24) {
            //                        PreparationTaskView(fileName: "animate-processing-task")
